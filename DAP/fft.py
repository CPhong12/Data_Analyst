...
def addSinunoidNoise_Demo():
    ...
    # print(max_val)
    delta = 5
    fft_shift[rows//4-delta:rows//4+delta,
              cols//4-delta:cols//4+delta] = max_val
    fft_shift[rows * 3//4 - delta:rows*3//4 + delta,
              cols // 4 - delta:cols // 4 + delta] = max_val
    fft_shift[rows * 3//4 - delta:rows*3//4 + delta, cols *
              3 // 4 - delta:cols * 3 // 4 + delta] = max_val
    fft_shift[rows // 4 - delta:rows//4 + delta, cols *
              3 // 4 - delta:cols * 3 // 4 + delta] = max_val
